...
return (
    <ProtectedRoute>
        <Container maxW="container.xl" my={"25px"}>
            ...
            <Text fontSize={"md"}>Strive is your personal finance tool for budgeting.
            Input your finances and target net worth and receive personalized suggestions
            on how to best reach your goal.  Suggestions are supported by calculations and
